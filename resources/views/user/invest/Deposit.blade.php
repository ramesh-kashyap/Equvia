...
<body>
    ...
    <div id="app">
            ...
            <div data-v-6b868a30="" class="headers">
                <div class="tw-px-16px tw-w-full tw-h-full tw-flex tw-items-center" data-v-6b868a30=""
                    ...
                    <div class="tw-flex-1 tw-h-full tw-flex tw-justify-center tw-items-center tw-text-16px van-ellipsis"
                        style="color: rgba(255, 255, 255, 1);"><span>Deposit</span></div>
            ...
            <div data-v-6b868a30="" id="scroll" class="content-container">
                <div data-v-6b868a30="" id="content" class="content-scroll">
                    <div data-v-4bcdfc27="" data-v-6b868a30="" class="page-recharge tw-min-h-full tw-p-16px">
                        <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-mb-10px tw-text-14px">Select Currency
                        </div>
                        <div data-v-4bcdfc27="" data-v-6b868a30=""
                            ...
                            </div><i data-v-4bcdfc27="" data-v-6b868a30="" class="van-icon van-icon-arrow"
                            ...
                            <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-mt-16px tw-p-16px">
                                ...
                                <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-flex tw-items-center"
                                    ...
                                    <div data-v-4bcdfc27="" data-v-6b868a30=""
                                        ...
                                        <p style="font-size: 16px; color:#fff" id="walletAddress"></p>
                                        <!-- <input type="hidden" id="walletAddress" readonly style="display: block; margin-top: 10px;"> -->
                                    </div>
                                    <div data-v-4bcdfc27="" data-v-6b868a30="" onclick="copyWallet()"> <svg
                        ...
                        <div data-v-4bcdfc27="" data-v-6b868a30=""
                            ...
                            <div data-v-4bcdfc27="" data-v-6b868a30="" class="tw-flex tw-items-center"><i
                                    ...
                                    class="tw-text-primary tw-pl-8px">Note</span>
                            </div>
                            <div data-v-4bcdfc27="" data-v-6b868a30=""
                                class="tw-text-14px tw-text-secondary tw-mt-8px">
                    ...
                    <div class="van-tabs__content">
                        <div role="tabpanel" class="van-tab__pane" style="">
                            <div
                                ...
                                <div class="tw-text-12px tw-text-secondary">
                                    <p> Estimated Arrival Time ≈ 1 minutes </p>
        ...
        <div class="van-overlay" id="global-loading" style="display: none;">
            <div class="tw-w-full tw-h-full tw-flex tw-justify-center tw-items-center">
                <div class="tw-w-100px tw-h-100px tw-flex tw-justify-center tw-items-center tw-bg-dark tw-bg-opacity-10 tw-rounded-10px"
                    style="background: rgb(22 23 24 / 80%); border:none">
                    <div class="van-loading van-loading--circular"><span
                            class="van-loading__spinner van-loading__spinner--circular"
                            style="color: rgba(106, 255, 124, 0.18); width: 2rem; height: 2rem;"><svg
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            let selectedNetwork = "trc20"; // default network

            // --- Function to fetch wallet details ---
            function fetchWalletDetails(network) {
                document.getElementById('global-loading').style.display = 'block';

                fetch(`/user/get-address-details/${network}`)
                    .then(response => response.json())
                    .then(data => {
                        console.log("API Response:", data);
            ...
            // --- Load default TRC20 on page load ---
            fetchWalletDetails(selectedNetwork);

            // --- Dropdown click opens popup ---
            ...
            popup.querySelectorAll(".chain-item").forEach(item => {
                item.addEventListener("click", () => {
                    ...
                    } else if (networkName === "Binance Smart Chain") {
